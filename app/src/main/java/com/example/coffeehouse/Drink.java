...
public class Drink {
    ...
    public static final Drink [] drinks = {
            new Drink("Latte", "It is a coffee-based drink made primarily from espresso and steamed milk. It consists of one-third espresso, two-thirds heated milk and about 1cm of foam. The foam can be poured in such a way to create a picture.", R.drawable.llatte),
            new Drink("Cappuccino", "It is a coffee-based drink made primarily from espresso and milk. It consists of one-third espresso, one-third heated milk and one-third milk foam", R.drawable.ccappuccino),
